...
class AlumnoForm(forms.ModelForm):
    ...
    class Meta:
        model = Alumnos
        fields = ('username', 'email', 'nombre', 'nombre2', 'apellidoP',
                  'apellidoM', 'telefono', 'password', 'repassword')
    email = forms.EmailField(required=True)
...
class ResponsableForm(forms.ModelForm):
    ...
    class Meta:
        model = Responsables
        fields = ('username', 'email', 'nombre', 'nombre2', 'apellidoP', 'apellidoM',
                  'programa_academico', 'unidad_academica', 'password', 'repassword')
