...
class TestFormResponsable(TestCase):
    ...
    def setUp(self, username='DanielCast', nombre='Daniel', nombre2='Alejandro', apellidoP='Morales',
              apellidoM='Castillo', email='amcdanymx@hotmail.com', programa_academico='IS', unidad_academica='IE',
              password='Ronaldinho999.', repassword='Ronaldinho999.'):
    ...
    def test_responsable_contraseña_con_almenos_una_letra(self):
        self.data['password'] = '123456789'
        form = ResponsableForm(self.data)
        self.assertEqual(form.errors['password'], [
                         'La contraseña debe contener al menos una letra'])

    def test_responsable_contraseña_con_mayuscula(self):
        self.data['password'] = 'holaaaaa.'
        form = ResponsableForm(self.data)
        self.assertEqual(form.errors['password'], [
                         'La contraseña debe contener al menos una letra mayuscula'])

    def test_responsable_contraseña_con_letra_minuscula(self):
        self.data['password'] = 'HOLAAAAAA'
        form = ResponsableForm(self.data)
        self.assertEqual(form.errors['password'], [
                         'La contraseña debe contener al menos una letra minuscula'])

    def test_responsable_contraseña_con_minuscula(self):
        self.data['password'] = 'Juanitooo22'
        form = ResponsableForm(self.data)
        self.assertEqual(form.errors['password'], [
                         'La contraseña debe contener al menos un caracter especial'])

    def test_responsable_contraseña_con_numero(self):
        self.data['password'] = 'Juanitooo.'
        form = ResponsableForm(self.data)
        self.assertEqual(form.errors['password'], [
                         'La contraseña debe contener al menos un número'])
