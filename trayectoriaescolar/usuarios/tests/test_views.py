...
from usuarios.views import RegistrarAdmin, RegistrarAlumno, RegistrarResponsable
...
class TestViewsCase(TestCase):
    ...
    def test_registrar_admin_estatus(self):
        self.deslogearse()
        self.logearseAdmin()
        respuesta = self.client.get('/registro_de_administrador', {}, follow=True)
        self.assertEquals(respuesta.status_code, 200)
    ...
    def test_template_registrar_admin_cuenta_responsable(self):
        ...
        respuesta = self.client.get('/registro_de_administrador', {}, follow=True)
        self.assertTemplateNotUsed('home_case.html')
    
    def test_template_registrar_admin_cuenta_alumno(self):
        self.deslogearse()
        self.logearseAlumno()
        respuesta = self.client.get('/registro_de_administrador', {}, follow=True)
        self.assertTemplateNotUsed('index_alumno.html')
