Característica: Alta de un nuevo responsable
    ...
    Escenario: Datos correctos de responsable
            ...
            Y en la sección de inicio de sesión ingreso los datos "amcdanymx" y contra "Ronaldinho999."
            ...
            Entonces la página me envia a la url "http://localhost:8000/home_case"
